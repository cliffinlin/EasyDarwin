...
namespace EasyDarwin { namespace Protocol
{
	...
	EasyProtocol::MsgType EasyProtocol::MsgTypeMap[] = {
		...
		MSG_SC_SERVER_INFO_ACK,							"MSG_SC_SERVER_INFO_ACK",
		MSG_SC_SERVER_BASE_CONFIG_ACK,					"MSG_SC_SERVER_BASE_CONFIG_ACK",
		MSG_SC_SERVER_SET_BASE_CONFIG_ACK,				"MSG_SC_SERVER_SET_BASE_CONFIG_ACK",
		MSG_SC_SERVER_GET_THRID_PART_PLATFORM_ACK,		"MSG_SC_SERVER_GET_THRID_PART_PLATFORM_ACK",
		MSG_SC_SERVER_SET_THRID_PART_PLATFORM_ACK,		"MSG_SC_SERVER_SET_THRID_PART_PLATFORM_ACK",
		MSG_SC_SERVER_GET_CHANNELS_ACK,					"MSG_SC_SERVER_GET_CHANNELS_ACK",
		MSG_SC_SERVER_GET_CHANNELS_CONFIG_ACK,			"MSG_SC_SERVER_GET_CHANNELS_CONFIG_ACK",
		MSG_SC_SERVER_SET_CHANNEL_CONFIG_ACK,			"MSG_SC_SERVER_SET_CHANNEL_CONFIG_ACK",
		MSG_SC_SERVER_GET_CHANNEL_STREAM_ACK,			"MSG_SC_SERVER_GET_CHANNEL_STREAM_ACK",
		MSG_SC_SERVER_LOGIN_ACK,						"MSG_SC_SERVER_LOGIN_ACK",
		MSG_SC_SERVER_LOGOUT_ACK,						"MSG_SC_SERVER_LOGOUT_ACK",
		MSG_SC_SERVER_MODIFY_PASSWORD_ACK,				"MSG_SC_SERVER_MODIFY_PASSWORD_ACK",

		MSG_SC_SERVER_TOUCH_CHANNEL_STREAM_ACK,			"MSG_SC_SERVER_TOUCH_CHANNEL_STREAM_ACK",
		MSG_SC_SERVER_DISCOVER_DEVICES_ACK,				"MSG_SC_SERVER_DISCOVER_DEVICES_ACK",
		MSG_SC_SERVER_PROBE_DEVICE_ACK,					"MSG_SC_SERVER_PROBE_DEVICE_ACK",

		MSG_SC_SERVER_GET_RECORD_PATH_LIST_ACK,			"MSG_SC_SERVER_GET_RECORD_PATH_LIST_ACK",
		MSG_SC_SERVER_ADD_RECORD_PATH_ACK,				"MSG_SC_SERVER_ADD_RECORD_PATH_ACK",
		MSG_SC_SERVER_REMOVE_RECORD_PATH_ACK,			"MSG_SC_SERVER_REMOVE_RECORD_PATH_ACK",

		MSG_SC_SERVER_START_RECORD_ACK,					"MSG_SC_SERVER_START_RECORD_ACK",
		MSG_SC_SERVER_STOP_RECORD_ACK,					"MSG_SC_SERVER_STOP_RECORD_ACK",

		MSG_SC_SERVER_SEARCH_RECORD_ACK,				"MSG_SC_SERVER_SEARCH_RECORD_ACK",
		MSG_SC_SERVER_PLAY_RECORD_ACK,					"MSG_SC_SERVER_PLAY_RECORD_ACK",
		MSG_SC_SERVER_STOP_PLAY_RECORD_ACK,				"MSG_SC_SERVER_STOP_PLAY_RECORD_ACK",
		MSG_SC_SERVER_SEEK_PLAY_RECORD_ACK,				"MSG_SC_SERVER_SEEK_PLAY_RECORD_ACK",
		MSG_SC_SERVER_TOUCH_PLAY_RECORD_ACK,			"MSG_SC_SERVER_TOUCH_PLAY_RECORD_ACK",

		MSG_SC_SERVER_USAGES_ACK,						"MSG_SC_SERVER_USAGES_ACK",

		MSG_SC_START_STREAM_ACK,						"MSG_SC_START_STREAM_ACK",
		MSG_SC_STOP_STREAM_ACK,							"MSG_SC_STOP_STREAM_ACK",

		MSG_SC_START_HLS_ACK,							"MSG_SC_START_HLS_ACK",
		MSG_SC_HLS_SESSION_LIST_ACK,					"MSG_SC_HLS_SESSION_LIST_ACK",
		MSG_SC_RTSP_LIVE_SESSIONS_ACK,					"MSG_SC_RTSP_LIVE_SESSIONS_ACK",
